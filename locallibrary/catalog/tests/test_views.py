...
class LoanedBookByUserViewTest(TestCase):
    def setUp(self):
        # Create two users
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(response, 'catalog/list_borrowed_user.html')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        response = self.client.get(reverse('catalog:renew', kwargs={'bookinstance_id': self.test_bookinstance1.pk}))
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        ...
        response = self.client.get(reverse('catalog:renew', kwargs={'bookinstance_id': self.test_bookinstance2.pk}))
    ...
    def test_HTTP404_for_invalid_book_if_logged_in(self):
        ...
        test_uid = uuid.uuid4()
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('catalog:renew', kwargs={'bookinstance_id': test_uid}))
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        response = self.client.post(reverse('catalog:renew', kwargs={'bookinstance_id': self.test_bookinstance1.pk}),
                                    {'renewal_date': valid_date_in_future})
        self.assertRedirects(response, reverse('catalog:borrowed'))
