...
class Author(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('catalog:author-detail', args=[self.id])
...
class Genre(models.Model):
    name = models.CharField(max_length=100, help_text='Enter a book genre (e.g. Science Fiction, Horror, etc.)')
...
class Language(models.Model):
    name = models.CharField(max_length=100, help_text='Enter the books natural language (e.g. English, French, etc.)')
